...
import (
	...
	"github.com/nautsio/docker_auth/auth_server/authn"
	"github.com/nautsio/docker_auth/auth_server/authz"
...
type Config struct {
	...
	Auth0Auth  *authn.Auth0AuthConfig         `yaml:"auth0_auth,omitempty"`
...
func validate(c *Config) error {
	...
	if c.Users == nil && c.GoogleAuth == nil && c.LDAPAuth == nil && c.MongoAuth == nil && c.Auth0Auth == nil {
